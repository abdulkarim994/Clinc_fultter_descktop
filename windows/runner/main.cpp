...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  // الحجم الابتدائي: واجهة سطح المكتب تنتقل إلى تخطيط ثلاثي الأعمدة فوق
  // حدّ الفصل 1100px، فلو فُتحت النافذة بعرض 1280 القالبي انفتحت على حافة
  ...
  // الفصل فتنطبق عناصر بعضها فوق بعض). القيمة تحت العرض الابتدائي عمداً
  // كي يبقى للمستخدم مجالُ تصغير معقول دون بلوغ نقطة الانكسار.
