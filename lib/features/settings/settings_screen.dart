...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // م163 — النمط أ «الصندوق الناعم» (قرار المالك): سمة حقول مركزية
    // تعيد تصميم كل حقول الإعدادات وقوائمها دفعةً واحدة — خلفية ناعمة
    // وزوايا 12 بلا خط سفلي، وإطار أخضر رقيق عند التركيز. لا مساس بأي
    // منطق أو مفاتيح.
    final inputTheme = Theme.of(context).copyWith(
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          // حدٌّ شعري خفيف يمنح الصندوق تعريفاً على خلفية البطاقة.
          borderSide: BorderSide(color: BrandColors.line, width: .7),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide:
              const BorderSide(color: BrandColors.brand600, width: 1.3),
        ),
      ),
    );
    return PopScope(
