      ...
      if (jsTruthy(r['appointment']))
        {
          ...
          'notes': '',
          'status': 'upcoming',
          // م164 — صف السجل يحمل عيادة سجله ليظهر في تبويبها الصحيح.
          'clinic': jsOr(r['clinic'], jsOr(r['clinic_id'], '')),
          '_src': 'rec',
        },
...
/// م164 — تستثني أيضاً «لم يحضر» (حالة نهائية) والاستراحات ☕ (ليست مريضاً).
